...
import com.carma.model.Miembro;
...
public class MiembroFacadeREST extends AbstractFacade<Miembro> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Miembro entity) {
        super.edit(entity);
    }
    ...
    public Miembro find(@PathParam("id") Integer id) {
